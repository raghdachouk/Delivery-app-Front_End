						...
						<KeyboardAvoidingView behavior="padding" enabled style={styles.form}>
								...
								{!this.state.focus ? (
									<View>
										<View style={styles.textwithicon}>
											...
											<Text style={styles.text1}>Saisissez une nouvelle adresse</Text>
										</View>
										<TextInput
									...
									<View style={styles.textwithicon}>
										...
										<Icon name="clear" size={25} color={colors.light} style={styles.xIcon} onPress={this.onFocus} />
									</View>
								)}
							</View>
							...
							<View style={styles.whiteCard}>
								<TouchableOpacity activeOpacity={0.8} onPress={this.onPossible}>
									<View style={styles.textwithicon}>
										<Icon name="access-alarm" size={scale(25)} color={colors.lightGrey2} />
										<Text style={styles.text3}>Dès que possible</Text>
										{this.state.pressed1 && (
											<Icon name="check" size={scale(25)} color={colors.darkGreen} style={styles.iconpos} />
										)}
									</View>
								</TouchableOpacity>
								<View style={styles.trait} />
								<TouchableOpacity activeOpacity={0.8} onPress={this.onPlanifier}>
									<View style={styles.textwithicon}>
										<Icon name="event-note" size={scale(25)} color={colors.lightGrey2} />
										<Text style={styles.text3}>Planifier une commande</Text>
										{this.state.pressed2 && (
											<Icon name="check" size={scale(25)} color={colors.darkGreen} style={styles.iconpos} />
										)}
									</View>
									{this.state.pressed2 && <Calender isVisible={this.state.pressed2} />}
								</TouchableOpacity>
							</View>
							...
							<View style={styles.whiteCard}>
								<TouchableOpacity activeOpacity={0.8} onPress={this.onVehicule}>
									<View style={styles.textwithicon}>
										<Icon name="directions-car" size={scale(25)} color={colors.lightGrey2} />
										<Text style={styles.text3}>Retrouvez-vous au niveau du véhicule </Text>
								...
								<TouchableOpacity activeOpacity={0.8} onPress={this.onChezVous}>
									<View style={styles.textwithicon}>
										<Icon name="store" size={scale(25)} color={colors.lightGrey2} />
