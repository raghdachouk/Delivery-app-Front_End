			...
			<ScrollView contentContainerStyle={{ flexGrow: 1 }}>
				<View style={styles.container}>
					<KeyboardAvoidingView behavior="position">
						...
						<Icon name="arrow-back" size={scale(30)} color={colors.white} style={styles.icon} onPress={this.goBack} />
						...
						<TextInput style={styles.input} placeholder="Ajouter un Commentaire" />
						...
						<TouchableOpacity activeOpacity={0.8} onPress={this.onAdd}>
							<Text style={styles.greenbutton}>
								Ajouter {this.state.count} au panier {'       '}
								{(prix * this.state.count).toFixed(2)} €
							</Text>
						</TouchableOpacity>
					</KeyboardAvoidingView>
				</View>
